...
Original file is located at
    https://colab.research.google.com/drive/1JxBTfamodxtUNuChN5Yt8ns3UARMG3Zy
"""
...
plt.xlabel("height")
plt.ylabel("weight")
ravi=linear_model.LinearRegression()
ravi.fit(height,weight)
X_height=[[12]]
print(ravi.predict(X_height))
